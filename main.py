...
def open_image():
    ...
    img_name = filedialog.askopenfilename(initialdir=".", title="Select Image", filetypes=(("images", "*.jpg"), ("images", "*.bmp"), ("images", "*.png"), ("images", "*.jpeg"), ("images", "*.gif")))
    print(img_name)
...
def call_haze():
    ...
    subprocess.call(f"python haze_remover.py \"{img_name}\"", shell=True)

    msg = tkinter.Label(root, text="Dehazing complete! Image stored as dehazed.jpg.")
